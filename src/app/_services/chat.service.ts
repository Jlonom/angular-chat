...
export class ChatService {
  ...
  getAll(chatsType: string, currentPage: number, itemsPerPage: number, countNewMessages: number): Observable<any> {
    return this.http.get(`${environment.apiUrl}/chat?chatsType=${chatsType}page=${currentPage}&limit=${itemsPerPage}&newMessagesOffset=${countNewMessages}`);
  }
