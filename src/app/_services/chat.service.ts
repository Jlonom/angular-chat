...
export class ChatService {
  ...
  getAll(currentPage: number, itemsPerPage: number, countNewMessages: number) {
    return this.http.get(`${environment.apiUrl}/chat?page=${currentPage}&limit=${itemsPerPage}&newMessagesOffset=${countNewMessages}`);
  }
